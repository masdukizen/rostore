<!-- Begin Page Content -->
<input type="hidden" id="base_path" value="<?php echo base_url('document/delivery'); ?>">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('document/createdelivery'); ?>" method="post">
                        <div class="col-lg">
                            <div class="form-group row mb-0">
                                <label for="no_do" class="col-form-label col-2">No. DO</label>
                                <input id="no_do" name="no_do" class="form-control form-control-sm col-3" value="D01-">
                                <div class="col-4"></div>
